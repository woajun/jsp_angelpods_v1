...
for (var i = 0; i< lat.length;i++){
     ...
     '    </div>' + 
     '    <div class="body">' + 
     '      <div class="img">' + thumbnailImage[i].innerHTML + '</div>' + 
     '      <div class="desc">' +
     '        <div class="ellipsis">'+ addr[i].innerHTML + '</div>' + 
     '        <div class="jibun ellipsis">'+addrDetail[i].innerHTML + '</div>' + 
     '        <div><a href="f_content_view.do?fbNum='+fbNum[i].innerHTML+'" > 게시물보기 </a></div>' + 
     '      </div>' + 
     '    </div>' +    
     '</div>';
